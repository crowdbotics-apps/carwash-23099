"""carwash_23099 URL Configuration
...
admin.site.site_header = "CarWash"
admin.site.site_title = "CarWash Admin Portal"
admin.site.index_title = "CarWash Admin"

# swagger
api_info = openapi.Info(
    title="CarWash API",
    default_version="v1",
    description="API documentation for CarWash App",
)
